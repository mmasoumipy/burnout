...
export default function Home({ navigation }) {
  ...
  const emotions = [
    { id: 'sad', label: 'Sad', image: require('./assets/sad.png') },
    { id: 'neutral', label: 'Neutral', image: require('./assets/neutral.png') },
    { id: 'happy', label: 'Happy', image: require('./assets/happy.png') },
    { id: 'excited', label: 'Excited', image: require('./assets/excited.png') },
    { id: 'relaxed', label: 'Relaxed', image: require('./assets/relaxed.png') },
  ];

  const handleEmotionClick = (emotion) => {
    setSelectedEmotion(emotion.id);
    alert(`You feel ${emotion.label}`);
  };
